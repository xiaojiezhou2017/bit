...
import { DependencyResolverExtension, PackageManagerInstallOptions } from '@teambit/dependency-resolver';
...
import { loadRequireableExtensions } from '@teambit/utils.load-extensions';
